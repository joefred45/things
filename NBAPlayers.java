...
public class NBAPlayers {
	private static int lastPrintedPercent = -1; 
    public static void main(String[] args) {
        ...
        for (int i = 0; i<simulationTimes; i++) {
        	...
        	{
        		ArrayList<String> lines = new ArrayList<>(originalLines);
		        ...
		        if (test1.getStringLength()>maxLength) {
		        	...
		        	//System.out.println("\nNew Biggest String Found! Length: "+maxLength);
		        }
        	}
    ...
    public static void printLoadingBar(int current, int total) {
        ...
        if (percent - lastPrintedPercent >= 1) {
